...
keel.UploadPanel = function(cfg){
	...
	this.setting = {
		...
		file_size_limit : this.fileSize || (1024*30) ,//上传文件体积上限，单位MB
	...
	keel.UploadPanel.superclass.constructor.call(this,{				
		tbar : [
			{text:'添加文件',ref:'../addBtn',iconCls:'add',scope:this},'-',
			{text:'上传',ref:'../uploadBtn',iconCls:'up',handler:this.startUpload,scope:this},'-',
			{text:'停止上传',ref:'../stopBtn',iconCls:'remove',handler:this.stopUpload,scope:this,disabled:true},'-',
