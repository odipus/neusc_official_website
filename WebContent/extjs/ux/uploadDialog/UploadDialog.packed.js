...
Ext.extend(Ext.ux.UploadDialog.Dialog, Ext.Window, {
		...
		var tt = {
			...
			uploading : {
				...
				"file-upload-canceled" : [{
					predicate : this.hasUnuploadedFiles,
					action : [this.setRecordCanceledState,
							this.updateProgressBar, this.prepareNextUploadTask,
							this.fireUploadCanceledEvent]
				}, {
					action : [this.resetUploadingFlag,
							this.setRecordCanceledState, this.updateToolbar,
							this.updateProgressBar,
							this.fireUploadCanceledEvent,
							this.fireUploadCompleteEvent],
					state : "ready"
	...
	fireBeforeFileUploadStartEvent : function(record) {
		return this.fireEvent("beforefileuploadstart", this, record
						.get("filename"), record) !== false
	},
