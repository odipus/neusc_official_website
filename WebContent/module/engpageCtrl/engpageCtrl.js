...
Ext.onReady(function() {
	...
	var pageStore = new Ext.data.Store({
                    ...
                    url: 'engPageAction!queryPagesByUpperPage',
                    autoLoad: true
                })
	            	...
	            	handler: function() {
	            		...
	            		var form = Ext.getCmp('addPage-form').getForm();
	                   	...
	                   	if (loadValid()) {
	                        ...
	                        Ext.Ajax.request({
			                    	waitMsg: '正在添加',
									url: 'engPageAction!addPage',
									params:{
			                        	'engPage.pageTitle': Ext.getCmp('pageTitle').getValue(),
		                            	'engPage.pageContent': KE.html('pageContent'),
		                            	'engPage.upperPage':parent.upperId,
			                        },
		        ...
		        buttons: [{
					...
					handler: function() {
	            		...
	            		var form = Ext.getCmp('updatePage-form').getForm();
							...
							Ext.Ajax.request({
			                    	waitMsg: '正在添加',
									url: 'engPageAction!updatePage',
									params:{
										'engPage.pageId': pageIdT,
			                        	'engPage.pageTitle': Ext.getCmp('pageTitleUp').getValue(),					                            
		                            	'engPage.pageContent': KE.html('pageContentUp'),
		                            	'engPage.upperPage':parent.upperId,
	...
	function winLoad() {
		...
		if(updateForm) {
			Ext.lib.Ajax.request(
				'post',
				'engPageAction!queryPageById',
				{
					success: function(response) {
						var data = Ext.decode(response.responseText);
						pageIdT = data.engPage.pageId;
						var pageTitleT = data.engPage.pageTitle;
						
						var pageContent = data.engPage.pageContent;
